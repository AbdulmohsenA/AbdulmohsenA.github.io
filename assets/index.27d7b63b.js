(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const c of i.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&s(c)}).observe(document,{childList:!0,subtree:!0});function o(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerpolicy&&(i.referrerPolicy=n.referrerpolicy),n.crossorigin==="use-credentials"?i.credentials="include":n.crossorigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(n){if(n.ep)return;n.ep=!0;const i=o(n);fetch(n.href,i)}})();function m(t,e){const o=document.querySelector(`#${t} .container`);e.forEach((s,n)=>{const i=document.createElement("div");i.className="card hidden",i.innerHTML=s.length>2?`<a href="${s[2]}" target="_blank"><img src="${s[1]}"></a>`:`<img src="${s[1]}">`,i.style.transitionDelay=`${200*(n+1)}ms`,i.setAttribute("data",s[0]),o.appendChild(i)})}const x=new IntersectionObserver(t=>{t.forEach(e=>{e.isIntersecting?e.target.classList.add("show"):e.target.classList.remove("show")})});function S(){const t=document.getElementById("cursor"),e=document.querySelector("#cursor > p");let o=window.getComputedStyle(t).backgroundColor.match(/\d+/g).map(n=>parseInt(n)),s=!1;document.addEventListener("dblclick",()=>{s=!s}),window.onmousemove=n=>{const i=n.target.closest(".card, h2"),c=i!==null,h=n.target.closest("a"),u=h!==null;$(n,c,u,o,s),c&&u?(e.innerHTML='<i class="fa-solid fa-arrow-up-right-from-square"></i>',e.style.opacity=1):c?(e.innerText=i.getAttribute("data"),e.style.opacity=1):e.innerText=""}}const $=(t,e,o,s,n)=>{const i=t.clientX-cursor.offsetWidth/2,c=t.clientY-cursor.offsetHeight/2;let h=1,u=`rgba(${s[0]}, ${s[1]}, ${s[2]}, ${+n})`,p=c;e&&(h=5,u=`rgba(${s[0]}, ${s[1]}, ${s[2]}, 0)`,p=c-100,o&&(p=c,u=`rgba(${s[0]}, ${s[1]}, ${s[2]}, 0)`));const _={backgroundColor:u,transform:`translate(${i}px, ${p}px) scale(${h})`};cursor.animate(_,{duration:600,fill:"forwards",easing:"ease"})},r={rotationDelay:0,scaleFactor:.5,degPerSec:6,angles:{x:-100,y:-20,z:0},colors:{water:"#111",land:"#424447",saudiArabia:"#E2B714",hover:"#ccc"}},a={currentCountry:null,lastTime:d3.now(),degPerMs:r.degPerSec/1e3,isDragging:!1,startX:0,startY:0,saudiArabia:null},l={countryLabel:d3.select("#countryLabel"),canvas:d3.select("#globe"),context:d3.select("#globe").node().getContext("2d")},d=d3.geoOrthographic().precision(.1),A=d3.geoPath(d).context(l.context);let v,L,y,b;const P=()=>{const t=d.rotate();t[0]=r.angles.x,t[1]=r.angles.y,t[2]=r.angles.z,d.rotate(t)},w=()=>{const t=document.documentElement.clientWidth*r.scaleFactor,e=document.documentElement.clientHeight*r.scaleFactor;l.canvas.attr("width",t).attr("height",e),d.scale(Math.min(t,e)/2).translate([t/2,e/2]),g()},D=t=>{v.restart(k,t||0)},j=t=>{a.isDragging=!0,a.startX=t.x,a.startY=t.y,v.stop()},E=t=>{if(!a.isDragging)return;const e=.25,o=(t.x-a.startX)*e,s=(t.y-a.startY)*e;a.startX=t.x,a.startY=t.y;const n=d.rotate();n[0]+=o,n[1]-=s,d.rotate(n),g()},q=()=>{a.isDragging=!1,D(r.rotationDelay)},g=()=>{const{context:t}=l,e=document.documentElement.clientWidth,o=document.documentElement.clientHeight;t.clearRect(0,0,e,o),f({type:"Sphere"},r.colors.water),f(L,r.colors.land),a.saudiArabia&&(l.countryLabel.style("color",r.colors.saudiArabia),f(a.saudiArabia,r.colors.saudiArabia)),a.currentCountry&&a.currentCountry!==a.saudiArabia&&(l.countryLabel.style("color","white"),f(a.currentCountry,r.colors.hover))},f=(t,e)=>{l.context.beginPath(),A(t),l.context.fillStyle=e,l.context.fill()},k=t=>{const e=d3.now(),o=e-a.lastTime;if(o<t){const s=d.rotate();s[0]+=o*a.degPerMs,d.rotate(s),g()}a.lastTime=e},T=async t=>{const e=await d3.json("https://unpkg.com/world-atlas@2.0.2/countries-110m.json");let o=await d3.tsv("https://gist.githubusercontent.com/mbostock/4090846/raw/07e73f3c2d21558489604a0bc434b3a5cf41a867/world-country-names.tsv");o[110].name="Palestine",t(e,o)},H=t=>{const e=d.invert(d3.pointer(t));return y.features.find(o=>o.geometry.coordinates.find(s=>d3.polygonContains(s,e)||s.some(n=>d3.polygonContains(n,e))))},C=t=>{const e=H(t);if(!e){a.currentCountry&&(M(),a.currentCountry=null,g());return}e!==a.currentCountry&&(a.currentCountry=e,g(),I(e))},I=t=>{var o;const e=((o=b.find(s=>parseInt(s.id)===parseInt(t.id)))==null?void 0:o.name)||"";l.countryLabel.text(e)},M=t=>{l.countryLabel.text("")},O=()=>{P(),l.canvas.call(d3.drag().on("start",j).on("drag",E).on("end",q)).on("mousemove",C).on("touchmove",C),T((t,e)=>{L=topojson.feature(t,t.objects.land),y=topojson.feature(t,t.objects.countries),b=e,a.saudiArabia=y.features.find(o=>{const s=b.find(n=>parseInt(n.id,10)===parseInt(o.id,10));return s&&s.name==="Saudi Arabia"}),window.addEventListener("resize",w),w(),v=d3.timer(k)})};document.querySelector("#app").innerHTML=`
  <div>
<section>
