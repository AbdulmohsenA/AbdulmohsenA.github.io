...
<section id='projects'>
  <h2 class = 'hidden' data='\u{1F6E0}\uFE0F'>\u0627\u0644\u0645\u0634\u0627\u0631\u064A\u0639</h2>
...
`;const g=[["3D Visualiser","./logos/3dVisualiser.png","https://abdulmohsena.github.io/Equation3D/"],["Schedule.it","./logos/scheduleit.png","https://scheduleit.up.railway.app/en"]],h=[["Python","./logos/Python-logo.png"],["JavaSript","./logos/JavaScript-logo.png"],["Java","./logos/java-logo.png"],["SQL","./logos/mysql.png"],["Docker","./logos/docker.png"],["PyTorch","./logos/pytorch.png"]],p=[["Github","./logos/github.png","https://github.com/AbdulmohsenA"],["LinkedIn","./logos/linkedin.png","https://www.linkedin.com/in/abdulmohsen-abanmy/"],["Kaggle","./logos/kaggle.png","https://www.kaggle.com/abdulmohsena"]];a("projects",g);a("skills",h);a("related",p);window.onload=n=>{document.querySelectorAll(".hidden").forEach(i=>c.observe(i))};d();
