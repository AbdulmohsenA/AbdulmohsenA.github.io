...
`;const u=[["3D Visualiser","./logos/3dVisualiser.png","https://abdulmohsena.github.io/Equation3D/"],["Schedule.it","./logos/scheduleit.png","https://scheduleit.up.railway.app/en"]],h=[["Python","./logos/Python-logo.png"],["JavaSript","./logos/JavaScript-logo.png"],["Java","./logos/java-logo.png"],["SQL","./logos/mysql.png"],["Docker","./logos/docker.png"]],p=[["LangChain","./logos/langchain.png"],["PyTorch","./logos/pytorch.png"],["THREE.JS","./logos/threejs.png"],["HuggingFace","./logos/huggingface.png"],["Git","./logos/git.png"],["Octoparse","./logos/octoparse.png"]],m=[["Github","./logos/github.png","https://github.com/AbdulmohsenA"],["LinkedIn","./logos/linkedin.png","https://www.linkedin.com/in/abdulmohsen-abanmy/"],["Kaggle","./logos/kaggle.png","https://www.kaggle.com/abdulmohsena"]];a("projects",u);a("skills",h);a("tools",p);a("related",m);window.onload=n=>{document.querySelectorAll(".hidden").forEach(i=>c.observe(i))};d();
