...
`;const u=[["3D Visualiser","./logos/3dVisualiser.png","https://abdulmohsena.github.io/Equation3D/"],["Schedule.it","./logos/scheduleit.png","https://scheduleit.up.railway.app/en"]],h=[["Python","./logos/Python-logo.png"],["JS","./logos/JavaScript-logo.png"],["Java","./logos/java-logo.png"],["SQL","./logos/mysql.png"],["Docker","./logos/docker.png"],["PyTorch","./logos/pytorch.png"]],g=[["Github","./logos/git.png","https://github.com/AbdulmohsenA"]];r("projects",u);r("skills",h);r("related",g);window.onload=n=>{document.querySelectorAll(".hidden").forEach(i=>d.observe(i))};a();
